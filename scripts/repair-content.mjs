...
const content = {
  ...
  timeline: [
    ...
    },
    {
      ...
      description:
        "Ленинский ЗАГС Екатеринбурга. На всякий случай приготовьте носовые платочки для трогательного момента"
    },
    {
      time: "14:00",
...
const databaseUrl =
  ...
  "postgresql://wedding_admin:wedding_password@localhost:5433/wedding_invite";
...
try {
  ...
  console.log("event_settings restored");
} finally {
  await pool.end();
}
